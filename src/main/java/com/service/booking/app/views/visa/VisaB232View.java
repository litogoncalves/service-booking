...
@PageTitle("Visa B232 | SIGAV - Sistema de Gestão de Agendamentos e Validações")
@Route(value = "visaB232", layout = MainLayout.class)
@AnonymousAllowed
public class VisaB232View extends VerticalLayout {
	...
	public VisaB232View(ServService servService, BookingService bookingService, IdentityDocumentService identityDocService, 
	...
	private Component createHeader() {
		headerDiv = new Div();
		header = new H4(Labels.DOCUMENT_TYPE_VISA_B232);
	...
	private Service createService() {
		Service service = servService.getServiceByName(Constants.VISA_B232);
		return service;
	}
	 ...
	 private void createConfirmDialog() {
		 try {
			 ...
			 if(binder.isValid()) {
				 ...
				 confirmDialog.add(new H5(Labels.BOOKING_CONFIRMATION+" "+Labels.DOCUMENT_TYPE_VISA_B232));
