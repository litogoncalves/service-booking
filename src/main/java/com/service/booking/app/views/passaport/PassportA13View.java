...
@PageTitle("Passaporte A13 | SIGAV - Sistema de Gestão de Agendamentos e Validações")
@Route(value = "passaportA13", layout = MainLayout.class)
@AnonymousAllowed
public class PassportA13View extends VerticalLayout{
	...
	public PassportA13View(ServService servService, BookingService bookingService, IdentityDocumentService identityDocService, 
	...
	private Component createHeader() {
		headerDiv = new Div();
		header = new H4(Labels.DOCUMEMT_TYPE_PASSPORT_A13);
	...
	private Service createService() {
		Service service = servService.getServiceByName(Constants.PASSPORT_A13);
		return service;
	}
