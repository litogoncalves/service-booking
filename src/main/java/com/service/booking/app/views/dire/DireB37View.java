...
@PageTitle("Dire B37 | SIGAV - Sistema de Gestão de Agendamentos e Validações")
@Route(value = "direB37", layout = MainLayout.class)
@AnonymousAllowed
public class DireB37View extends VerticalLayout {
private static final long serialVersionUID = 1L;
	...
	public DireB37View(ServService servService, BookingService bookingService, IdentityDocumentService identityDocService, 
	...
	private Component createHeader() {
		headerDiv = new Div();
		header = new H4(Labels.DOCUMENT_TYPE_DIRE_B37);
	...
	private Service createService() {
		Service service = servService.getServiceByName(Constants.DIRE_B37);
		return service;
	}
	 ...
	 private void createConfirmDialog() {
		 try {
			 ...
			 if(binder.isValid()) {
				 ...
				 confirmDialog.add(new H5(Labels.BOOKING_CONFIRMATION+" "+Labels.DOCUMENT_TYPE_DIRE_B37));
