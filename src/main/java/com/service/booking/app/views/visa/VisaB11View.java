...
@PageTitle("Visa B11 | SIGAV - Sistema de Gestão de Agendamentos e Validações")
@Route(value = "visaB11", layout = MainLayout.class)
@AnonymousAllowed
public class VisaB11View extends VerticalLayout{
	...
	public VisaB11View(ServService servService, BookingService bookingService, IdentityDocumentService identityDocService, 
	...
	private Component createHeader() {
		headerDiv = new Div();
		header = new H4(Labels.DOCUMENT_TYPE_VISA_B11);
	...
	private Service createService() {
		Service service = servService.getServiceByName(Constants.VISA_B11);
		return service;
	}
	...
	private Component createButtons() {
	 ...
	 private void createConfirmDialog() {
		 try {
			 ...
			 confirmDialog.add(new H5(Labels.BOOKING_CONFIRMATION+" "+Labels.DOCUMENT_TYPE_VISA_B11));
