...
@PageTitle("Passaporte A14 | SIGAV - Sistema de Gestão de Agendamentos e Validações")
@Route(value = "passaportA14", layout = MainLayout.class)
@AnonymousAllowed
public class PassportA14View extends VerticalLayout {
	...
	public PassportA14View(ServService servService, BookingService bookingService, IdentityDocumentService identityDocService, 
	...
	private Component createHeader() {
		headerDiv = new Div();
		header = new H4(Labels.DOCUMEMT_TYPE_PASSPORT_A14);
	...
	private Service createService() {
		Service service = servService.getServiceByName(Constants.PASSPORT_A14);
		return service;
	}
	...
	private Component createButtons() {
	 ...
	 private void createConfirmDialog() {
		 try {
			 ...
			 confirmDialog.add(new H5(Labels.BOOKING_CONFIRMATION+" "+Labels.DOCUMEMT_TYPE_PASSPORT_A14));
