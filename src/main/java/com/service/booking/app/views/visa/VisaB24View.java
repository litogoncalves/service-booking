...
@PageTitle("Visa B24 | SIGAV - Sistema de Gestão de Agendamentos e Validações")
@Route(value = "visaB24", layout = MainLayout.class)
@AnonymousAllowed
public class VisaB24View extends VerticalLayout {
	...
	public VisaB24View(ServService servService, BookingService bookingService, IdentityDocumentService identityDocService, 
	...
	private Component createHeader() {
		headerDiv = new Div();
		header = new H4(Labels.DOCUMENT_TYPE_VISA_B24);
	...
	private Service createService() {
		Service service = servService.getServiceByName(Constants.VISA_B24);
		return service;
	}
	 ...
	 private void createConfirmDialog() {
		 try {
			 ...
			 if(binder.isValid()) {
				 ...
				 confirmDialog.add(new H5(Labels.BOOKING_CONFIRMATION+" "+Labels.DOCUMENT_TYPE_VISA_B24));
