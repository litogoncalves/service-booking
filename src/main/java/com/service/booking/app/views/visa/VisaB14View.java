...
@PageTitle("Visa B14 | SIGAV - Sistema de Gestão de Agendamentos e Validações")
@Route(value = "visaB14", layout = MainLayout.class)
@AnonymousAllowed
public class VisaB14View extends VerticalLayout {
	...
	public VisaB14View(ServService servService, BookingService bookingService, IdentityDocumentService identityDocService, 
	...
	private Component createHeader() {
		headerDiv = new Div();
		header = new H4(Labels.DOCUMENT_TYPE_VISA_B14);
	...
	private Service createService() {
		Service service = servService.getServiceByName(Constants.VISA_B14);
		return service;
	}
	 ...
	 private void createConfirmDialog() {
		 try {
			 ...
			 if(binder.isValid()) {
				 ...
				 confirmDialog.add(new H5(Labels.BOOKING_CONFIRMATION+" "+Labels.DOCUMENT_TYPE_VISA_B14));
