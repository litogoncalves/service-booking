...
@PageTitle("Dire B35 | SIGAV - Sistema de Gestão de Agendamentos e Validações")
@Route(value = "direB35", layout = MainLayout.class)
@AnonymousAllowed
public class DireB35View extends VerticalLayout {
	...
	public DireB35View(ServService servService, BookingService bookingService, IdentityDocumentService identityDocService, 
	...
	private Component createHeader() {
		headerDiv = new Div();
		header = new H4(Labels.DOCUMENT_TYPE_DIRE_B35);
	...
	private Service createService() {
		Service service = servService.getServiceByName(Constants.DIRE_B35);
		return service;
	}
	 ...
	 private void createConfirmDialog() {
		 try {
			 ...
			 if(binder.isValid()) {
				 ...
				 confirmDialog.add(new H5(Labels.BOOKING_CONFIRMATION+" "+Labels.DOCUMENT_TYPE_DIRE_B35));
