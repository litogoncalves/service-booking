...
@PageTitle("Visa B231 | SIGAV - Sistema de Gestão de Agendamentos e Validações")
@Route(value = "visaB231", layout = MainLayout.class)
@AnonymousAllowed
public class VisaB231View extends VerticalLayout {
	...
	public VisaB231View(ServService servService, BookingService bookingService, IdentityDocumentService identityDocService, 
	...
	private Component createHeader() {
		headerDiv = new Div();
		header = new H4(Labels.DOCUMENT_TYPE_VISA_B21);
	...
	private Service createService() {
		Service service = servService.getServiceByName(Constants.VISA_B21);
		return service;
	}
