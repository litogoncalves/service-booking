...
@PageTitle("Dire B38 | SIGAV - Sistema de Gestão de Agendamentos e Validações")
@Route(value = "direB38", layout = MainLayout.class)
@AnonymousAllowed
public class DireB38View extends VerticalLayout {
...
private static final long serialVersionUID = 1L;
	...
	public DireB38View(ServService servService, BookingService bookingService, IdentityDocumentService identityDocService, 
	...
	private Component createHeader() {
		headerDiv = new Div();
		header = new H4(Labels.DOCUMENT_TYPE_DIRE_B38);
	...
	private Service createService() {
		Service service = servService.getServiceByName(Constants.DIRE_B38);
		return service;
	}
	...
	private void createModality() {
		List<Modality> modalityItems = modalityService.findModalityByCategory(Constants.DIRE_NORMAL);
	 ...
	 private void createConfirmDialog() {
		 try {
			 ...
			 if(binder.isValid()) {
				 ...
				 confirmDialog.add(new H5(Labels.BOOKING_CONFIRMATION+" "+Labels.DOCUMENT_TYPE_DIRE_B38));
