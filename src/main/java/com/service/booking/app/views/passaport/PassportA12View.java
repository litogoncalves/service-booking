...
@PageTitle("Passaporte A12 | SIGAV - Sistema de Gestão de Agendamentos e Validações")
@Route(value = "passaportA12", layout = MainLayout.class)
@AnonymousAllowed
public class PassportA12View extends VerticalLayout {
	...
	public PassportA12View(ServService servService, BookingService bookingService, IdentityDocumentService identityDocService, 
	...
	private Component createHeader() {
		headerDiv = new Div();
		header = new H4(Labels.DOCUMEMT_TYPE_PASSPORT_A12);
	...
	private Service createService() {
		Service service = servService.getServiceByName(Constants.PASSPORT_A12);
		return service;
	}
	 ...
	 private void createConfirmDialog() {
		 try {
			 ...
			 if(binder.isValid()) {
				 ...
				 confirmDialog.add(new H5(Labels.BOOKING_CONFIRMATION+" "+Labels.DOCUMEMT_TYPE_PASSPORT_A12));
