...
@PageTitle("Documento B4 | SIGAV - Sistema de Gestão de Agendamentos e Validações")
@Route(value = "documentB4", layout = MainLayout.class)
@AnonymousAllowed
public class DocumentB4View extends VerticalLayout {
	...
	public DocumentB4View(ServService servService, BookingService bookingService, IdentityDocumentService identityDocService, 
	...
	private Component createHeader() {
		headerDiv = new Div();
		header = new H4(Labels.DOCUMENT_TYPE_TRIP_B4);
	...
	private Service createService() {
		Service service = servService.getServiceByName(Constants.DOCUMENT_B4);
		return service;
	}
	 ...
	 private void createConfirmDialog() {
		 try {
			 ...
			 if(binder.isValid()) {
				 ...
				 confirmDialog.add(new H5(Labels.BOOKING_CONFIRMATION+" "+Labels.DOCUMENT_TYPE_TRIP_B4));
