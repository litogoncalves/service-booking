...
@PageTitle("Visa B132 | SIGAV - Sistema de Gestão de Agendamentos e Validações")
@Route(value = "visaB132", layout = MainLayout.class)
@AnonymousAllowed
public class VisaB132View extends VerticalLayout {
	...
	public VisaB132View(ServService servService, BookingService bookingService, IdentityDocumentService identityDocService, 
	...
	private Component createHeader() {
		headerDiv = new Div();
		header = new H4(Labels.DOCUMENT_TYPE_VISA_B132);
	...
	private Service createService() {
		Service service = servService.getServiceByName(Constants.VISA_B132);
		return service;
	}
	...
	private Component createButtons() {
	 ...
	 private void createConfirmDialog() {
		 try {
			 ...
			 confirmDialog.add(new H5(Labels.BOOKING_CONFIRMATION+" "+Labels.DOCUMENT_TYPE_VISA_B132));
