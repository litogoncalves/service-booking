...
@PageTitle("Visa B26 | SIGAV - Sistema de Gestão de Agendamentos e Validações")
@Route(value = "visaB26", layout = MainLayout.class)
@AnonymousAllowed
public class VisaB26View extends VerticalLayout {
	...
	public VisaB26View(ServService servService, BookingService bookingService, IdentityDocumentService identityDocService, 
	...
	private Component createHeader() {
		headerDiv = new Div();
		header = new H4(Labels.DOCUMENT_TYPE_VISA_B26);
	...
	private Service createService() {
		Service service = servService.getServiceByName(Constants.VISA_B26);
		return service;
	}
	 ...
	 private void createConfirmDialog() {
		 try {
			 ...
			 if(binder.isValid()) {
				 ...
				 confirmDialog.add(new H5(Labels.BOOKING_CONFIRMATION+" "+Labels.DOCUMENT_TYPE_VISA_B26));
