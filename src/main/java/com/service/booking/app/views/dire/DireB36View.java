...
@PageTitle("Dire B36 | SIGAV - Sistema de Gestão de Agendamentos e Validações")
@Route(value = "direB36", layout = MainLayout.class)
@AnonymousAllowed
public class DireB36View extends VerticalLayout {
	...
	public DireB36View(ServService servService, BookingService bookingService, IdentityDocumentService identityDocService, 
	...
	private Component createHeader() {
		headerDiv = new Div();
		header = new H4(Labels.DOCUMENT_TYPE_DIRE_B36);
	...
	private Service createService() {
		Service service = servService.getServiceByName(Constants.DIRE_B36);
		return service;
	}
	 ...
	 private void createConfirmDialog() {
		 try {
			 ...
			 if(binder.isValid()) {
				 ...
				 confirmDialog.add(new H5(Labels.BOOKING_CONFIRMATION+" "+Labels.DOCUMENT_TYPE_DIRE_B36));
