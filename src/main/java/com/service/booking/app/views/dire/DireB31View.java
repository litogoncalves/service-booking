...
@PageTitle("Dire B31 | SIGAV - Sistema de Gestão de Agendamentos e Validações")
@Route(value = "direB31", layout = MainLayout.class)
@AnonymousAllowed
public class DireB31View extends VerticalLayout {
	...
	public DireB31View(ServService servService, BookingService bookingService, IdentityDocumentService identityDocService, 
	...
	private Component createHeader() {
		headerDiv = new Div();
		header = new H4(Labels.DOCUMENT_TYPE_DIRE_B31);
	...
	private Service createService() {
		Service service = servService.getServiceByName(Constants.DIRE_B31);
		return service;
	}
	 ...
	 private void createConfirmDialog() {
		 try {
			 ...
			 if(binder.isValid()) {
				 ...
				 confirmDialog.add(new H5(Labels.BOOKING_CONFIRMATION+" "+Labels.DOCUMENT_TYPE_DIRE_B31));
