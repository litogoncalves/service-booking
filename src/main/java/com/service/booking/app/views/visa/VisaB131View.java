...
@PageTitle("Visa B131 | SIGAV - Sistema de Gestão de Agendamentos e Validações")
@Route(value = "visaB131", layout = MainLayout.class)
@AnonymousAllowed
public class VisaB131View extends VerticalLayout{
...
private static final long serialVersionUID = 1L;
	...
	public VisaB131View(ServService servService, BookingService bookingService, IdentityDocumentService identityDocService, 
	...
	private Component createHeader() {
		headerDiv = new Div();
		header = new H4(Labels.DOCUMENT_TYPE_VISA_B131);
	...
	private Service createService() {
		Service service = servService.getServiceByName(Constants.VISA_B131);
		return service;
	}
	 ...
	 private void createConfirmDialog() {
		 try {
			 ...
			 if(binder.isValid()) {
				 ...
				 confirmDialog.add(new H5(Labels.BOOKING_CONFIRMATION+" "+Labels.DOCUMENT_TYPE_VISA_B131));
