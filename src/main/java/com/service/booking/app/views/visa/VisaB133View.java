...
@PageTitle("Visa B133 | SIGAV - Sistema de Gestão de Agendamentos e Validações")
@Route(value = "visaB133", layout = MainLayout.class)
@AnonymousAllowed
public class VisaB133View extends VerticalLayout {
	...
	public VisaB133View(ServService servService, BookingService bookingService, IdentityDocumentService identityDocService, 
	...
	private Component createHeader() {
		headerDiv = new Div();
		header = new H4(Labels.DOCUMENT_TYPE_VISA_B133);
	...
	private Service createService() {
		Service service = servService.getServiceByName(Constants.VISA_B133);
		return service;
	}
